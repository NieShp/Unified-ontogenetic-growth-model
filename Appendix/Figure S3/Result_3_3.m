...
par.h = 0; 
par.ideal_C_content = 0.85;
par.ideal_N_content = 1 - par.ideal_C_content; 


tt = 1;
for initial_consumer_C = linspace(0.85, 0.95, 101)
    initial_consumer_C
    for food_C = linspace(0.85, 0.95, 101)
        ...
        RE(tt,1:2) = [initial_consumer_C,  food_C];
        RE(tt,3:5) = mass(:,end)';
        ...
        RE(tt,9:12) = [par.M_E, NC_trend, ...
            ...
            initial_consumer_C - min(1/(1 + par.ideal_N_content/par.ideal_C_content* par.GGE_C), par.theta_C)];
        tt = tt +1;        
