...
tau = 0.5;  % step for simualation
Time = 299; % simulation time
...
subplot(242)
plot(1:Time,C_Track(1,:)./sum(C_Track,1),'ro-','MarkerIndices', 10:30:Time, 'linewidth',2,'MarkerSize',8, 'MarkerFaceColor', 'r'); hold on;
plot(1:Time,C_Track(2,:)./sum(C_Track,1),'ks-','MarkerIndices',30:30:Time, 'linewidth',2,'MarkerSize',8, 'MarkerFaceColor', 'k'); hold on;
plot(1:Time,C_Track(3,:)./sum(C_Track,1),'b^-','MarkerIndices', 20:30:Time, 'linewidth',2,'MarkerSize',8, 'MarkerFaceColor', 'b'); hold on;
plot(1:Time,C_Track(4,:)./sum(C_Track,1),'m<-','MarkerIndices',10:30:Time, 'linewidth',2,'MarkerSize',8, 'MarkerFaceColor', 'm'); hold on;
...
subplot(243)
plot(1:Time,N_Track(1,:)./sum(N_Track,1),'ro-','MarkerIndices', 10:30:Time, 'linewidth',2,'MarkerSize',8, 'MarkerFaceColor', 'r'); hold on;
plot(1:Time,N_Track(2,:)./sum(N_Track,1),'ks-','MarkerIndices',30:30:Time, 'linewidth',2,'MarkerSize',8, 'MarkerFaceColor', 'k'); hold on;
plot(1:Time,N_Track(3,:)./sum(N_Track,1),'b^-','MarkerIndices', 20:30:Time, 'linewidth',2,'MarkerSize',8, 'MarkerFaceColor', 'b'); hold on;
plot(1:Time,N_Track(4,:)./sum(N_Track,1),'m<-','MarkerIndices',30:30:Time, 'linewidth',2,'MarkerSize',8, 'MarkerFaceColor', 'm'); hold on;
legend({'Excretion','Maintainance & activity','Biosynthesis','Releasing'},'EdgeColor', [1 1 1]);
ylim([0 1])
...
subplot(244)
plot(1:Time,E_Track(1,:)./sum(E_Track,1),'ro-','MarkerIndices', 10:30:Time, 'linewidth',2,'MarkerSize',8, 'MarkerFaceColor', 'r'); hold on;
plot(1:Time,(E_Track(2,:) + E_Track(3,:))./sum(E_Track,1),'ks-','MarkerIndices',30:30:Time, 'linewidth',2,'MarkerSize',8, 'MarkerFaceColor', 'k'); hold on;
plot(1:Time,E_Track(4,:)./sum(E_Track,1),'b^-','MarkerIndices',30:30:Time, 'linewidth',2,'MarkerSize',8, 'MarkerFaceColor', 'b'); hold on;
plot(1:Time,E_Track(5,:)./sum(E_Track,1),'m<-','MarkerIndices',20:30:Time, 'linewidth',2,'MarkerSize',8, 'MarkerFaceColor', 'm'); hold on;
plot(1:Time,E_Track(6,:)./sum(E_Track,1),'gd-','MarkerIndices', 10:30:Time, 'linewidth',2,'MarkerSize',8, 'MarkerFaceColor', 'g'); hold on;
